#include "rio-e/Systems/PropertyCreatorMgr.h"
...
namespace rioe
{
	...
	std::vector<std::string> PropertyCreatorMgr::GetAvailableProperties()
	{
	...
	std::unique_ptr<IProperty> PropertyCreatorMgr::CreateProperty(const std::string& type) {
